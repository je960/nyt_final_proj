...
#regress total number of deaths in each state to explanatory variables - by county
#measure total number of deaths per county and join w/ explorer data then run multivariable regression 

## Preceptor's primer - Appendix D - among 3 links, 'Mastering Shiny' by Hadley Wickam - Ch.2 ('Your first shiny app')
#save maps function for next week 
